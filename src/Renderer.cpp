...
void Renderer::CreateGrassDescriptorSetLayout() {
    ...
    VkDescriptorSetLayoutBinding bindings[] = { grassLayoutBinding };
...
void Renderer::CreateDescriptorPool() {
    ...
    std::vector<VkDescriptorPoolSize> poolSizes = {
        ...
        // grass models
        { VK_DESCRIPTOR_TYPE_STORAGE_BUFFER , (uint32_t)scene->GetBlades().size() },
    };
...
void Renderer::CreateGrassDescriptorSets() {
    ...
    // This should involve creating descriptor sets which point to 
    // the model matrix of each group of grass blades
    // Done
